...
final class NewsFooter: UITableViewHeaderFooterView {
    
    static let reusedIdentifier = "NewsFooter"
    var likeTapped: (() -> Void)?
...
//        setView()
    ...
    private func setView() {
        ...
        NSLayoutConstraint.activate([
            ...
            repostView.trailingAnchor.constraint(equalTo: likeView.trailingAnchor, constant: -50),
        ...
        NSLayoutConstraint.activate([
            ...
            commentControl.trailingAnchor.constraint(equalTo: repostView.trailingAnchor, constant: -50),
        ...
        NSLayoutConstraint.activate([
            ...
            viewsControl.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 35),
            viewsControl.heightAnchor.constraint(equalToConstant: 25),
            viewsControl.widthAnchor.constraint(equalToConstant: 25)
        ])
        // #colorLiteral(red: 0.6299125552, green: 0.8330814242, blue: 1, alpha: 1)
